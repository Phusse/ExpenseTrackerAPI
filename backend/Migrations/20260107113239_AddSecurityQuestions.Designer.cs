...
namespace ExpenseTracker.Migrations
{
    ...
    [Migration("20260107113239_AddSecurityQuestions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseTracker.Models.SecurityQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "QuestionOrder")
                        .IsUnique();
            ...
            modelBuilder.Entity("ExpenseTracker.Models.UserSettings", b =>
                {
                    ...
                    b.Property<int>("BudgetReminderDay")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ExpenseTracker.Models.UserSettings", b =>
                {
                    b.HasOne("ExpenseTracker.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("ExpenseTracker.Models.UserSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
